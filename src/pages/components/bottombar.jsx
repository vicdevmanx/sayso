    ...
    return (
        <div className='fixed bottom-4 w-screen flex justify-center'>
            <div className='bg-[#1c1f2690] backdrop-blur-sm rounded-full flex items-center gap-6 border border-[#272b34] p-1'>
                <NavLink to="/">
                {({isActive}) => (
                <div className={clsx('p-2', 'rounded-full',  'transition', isActive ? 'text-white' : 'text-[#717889]', isActive ? 'bg-[#3c74dd]' :  'bg-transparent', isActive ? 'hover:bg-[#3c74dd]' : 'hover:bg-[#272b34]')}>
                    <Home/>
                    </div>
                )}
                </NavLink>
